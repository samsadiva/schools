...
<html lang="en-RW">
    <head>
        ...
        <title>Schools and Internships</title>
        <style type="text/css">
...
.dropdown-menu a{padding-left: 30px;}
    ...
    <body>
      ...
      <div class="col-md-8" style="padding-top: 10px;"><h4>Schools and internships Solution
        <a class="btn btn-square btn-light m-1" href="" style="display: inline;"><img src="image/phone-icon.png" width="30px;" height="30px"style="display: inline;"></a>
                                            <a class="btn btn-square btn-light m-1" href="" style="display: inline;"><img src="image/twitter.png" width="30px" height="30px"></a>
                                            <a class="btn btn-square btn-light m-1" href="" style="display: inline;"><img src="image/youtube.png" width="30px" height="30px"></a>
      </h4>
 ...
 <div class="container-fluid" style="top: 210px;position: absolute;z-index: 999;">
                    <div class="row">
                        <div class="col-md-10" style="border-right: 1px solid rgba(0, 0, 0, 0.5); background-image: url('image/showschool.jpg');background-size: cover;background-repeat: no-repeat;background-attachment: fixed;padding: 0;"><div style="background-color:rgba(0, 0, 0, 0.4);width: 100%; height: 100%;position: relative;"><br><br>

                             <div class="caption" style="z-index: 9;position: relative;background-color: transparent;width: 98%;border-radius: 10px;left: 10px;padding: 10px;">
                   ...
                   <!-- Your Carousel HTML goes here -->


                      <!-- About Start -->
    <div class="container-fluid py-5" style="background-color: rgba(255, 255, 255, 0.9);">
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div class="about-img">
                        <img class="img-fluid" src="image/man.png">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <div class="btn btn-sm border rounded-pill text-primary px-3 mb-3">About Us</div>
                    <h4 class="mb-4">We help people to find schools and internship of their choice</h4>
                    <h6 class="mb-4">Tempor erat elitr rebum at clita. Diam dolor diam ipsum et tempor sit. Aliqu diam
                        amet diam et eos labore. Clita erat ipsum et lorem et sit, sed stet no labore lorem sit. Sanctus
                        clita duo justo et tempor eirmod magna dolore erat amet</h6>
                    <div class="row g-3">
                        <div class="col-sm-6">
                    ...
                    <div class="d-flex align-items-center mt-4">
                        ...
                        <a class="btn btn-outline-primary btn-square me-3" href=""><img src="image/facebook.png" width="40px" height="40px"></a>
                        <a class="btn btn-outline-primary btn-square me-3" href=""><img src="image/twitter.png" width="40px" height="40px"></a>
                        <a class="btn btn-outline-primary btn-square me-3" href=""><img src="image/instagram.png" width="40px" height="40px"></a>
                        <a class="btn btn-outline-primary btn-square" href=""><img src="image/linkedin.png" width="40px" height="40px"></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container pt-5">
            <div class="row g-5">
                <div class="col-lg-6 align-self-center mb-md-5 pb-md-5 wow fadeIn" data-wow-delay="0.3s">
                    ...
                    <h5 class="text-white mb-4">We are the best ever company</h5>
                    <h6 class="text-light mb-4">Aliqu diam amet diam et eos labore. Clita erat ipsum et lorem et sit, sed
                        stet no labore lorem sit. Sanctus clita duo justo et tempor</h6>
                    ...
                    <div class="row g-4 pt-3">
                        <div class="col-sm-6">
                            <div class="d-flex rounded p-3" style="background: rgba(256, 256, 256, 0.1);">
                                ...
                                <div class="ms-3">
                                    <h5 class="text-white mb-0" data-toggle="counter-up">9999</h5>
                                    <h6 class="text-white mb-0">Happy Clients</h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="d-flex rounded p-3" style="background: rgba(256, 256, 256, 0.1);">
                                ...
                                <div class="ms-3">
                                    <h5 class="text-white mb-0" data-toggle="counter-up">9999</h5>
                                    <h6 class="text-white mb-0">Project Complete</h6>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                <div class="col-lg-5 wow fadeIn" data-wow-delay="0.1s">
                    ...
                    <h4 class="mb-4">Meet Our Experienced Team Members</h4>
                    <h6 class="mb-4">Tempor erat elitr rebum at clita. Diam dolor diam ipsum et tempor sit. Aliqu diam
                        amet diam et eos labore. Clita erat ipsum et lorem et sit, sed stet no labore lorem sit. Sanctus
                        clita duo justo et tempor eirmod magna dolore erat amet</h6>
                            ...
                            <div class="row g-4">
                                <div class="col-12 wow fadeIn" data-wow-delay="0.1s">
                                    <div class="team-item bg-white text-center rounded p-4 pt-0">
                                        <img class="img-fluid rounded-circle p-4" src="image/jer.png" alt="">
                                        <h5 class="mb-0">Jeremy</h5>
                                        <small>Founder & CEO</small>
                                          <div class="d-flex justify-content-center mt-3">
                                            <a class="btn btn-square btn-light m-1" href=""><img src="image/facebook.png" width="40px" height="40px"></a>
                                            <a class="btn btn-square btn-light m-1" href=""><img src="image/twitter.png" width="40px" height="40px"></a>
                                            <a class="btn btn-square btn-light m-1" href=""><img src="image/tiktok.png" width="40px" height="40px"></a>
                                            <a class="btn btn-square btn-light m-1" href=""><img src="image/youtube.png" width="40px" height="40px"></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 wow fadeIn" data-wow-delay="0.5s">
                                    <div class="team-item bg-white text-center rounded p-4 pt-0">
                                        <img class="img-fluid rounded-circle p-4" src="image/sam.jpg" alt="">
                                        <h5 class="mb-0">NDATIMANA Samuel</h5>
                        ...
                        <div class="col-md-6 pt-md-4">
                            <div class="row g-4">
                                <div class="col-12 wow fadeIn" data-wow-delay="0.3s">
                                    <div class="team-item bg-white text-center rounded p-4 pt-0">
                                        <img class="img-fluid rounded-circle p-4" src="image/yves.jpg" alt="">
                                        <h5 class="mb-0">ishimwe yves</h5>
                                        <small>Co Founder & Assistant Developer</small>
                                        <div class="d-flex justify-content-center mt-3">
                                            <a class="btn btn-square btn-light m-1" href=""><img src="image/facebook.png" width="40px" height="40px"></a>
                                            <a class="btn btn-square btn-light m-1" href=""><img src="image/twitter.png" width="40px" height="40px"></a>
                                            <a class="btn btn-square btn-light m-1" href=""><img src="image/tiktok.png" width="40px" height="40px"></a>
                                ...
                                <div class="col-md-2">
                                    <img src="image/ads.png"><img src="image/nurse.jpg" style="width: 100%;">
                                </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <!-- start forgotten process -->

      <div id="hidandshowforgotten" style="display: none;">
          <div id="txtHint" style="color: red;"><!-- this is where the error will be displayed like incorrect input--></div>
          <div class="form-floating input-group"><span class="input-group-text"><img src="image/email.PNG" width="40px;"></span>
            <input type="e-mail" required="required" class="form-control" placeholder="Enter Your Phone E-mail Here ..." id="valf" onkeyup="chechinputemail(this.value)"><label for="floatingInput" style="padding-left: 70px;"> &nbsp;&nbsp;Enter E-Mail ...</label><span class="input-group-text"><img src="image/email" width="20px;"></span>
          </div><br>
          <br><p>OTP code Sent To your Email verify </p>
          <button type="button" class="form-control btn btn-lg btn-primary" onclick="showforgotten(document.getElementById('valf').value">Send</button><br><br>
          <button type="button" class="btn btn-light" onclick="login()" style="background-color: lightblue;">Back to Log In</button>
        </div><!-- end div show and hide forgotten--> 
...
function login(){
  ...
  document.getElementById("hidandshowforgotten").style.display='none';

}
// when forgot password button is clicked
function forgotten(){
  document.getElementById("hidandshowlogin").style.display='none';
  document.getElementById("hidandshowforgotten").style.display='inline';
}
...
//Custom script for automatic sliding 
// Set the interval in milliseconds (e.g., 5000 for 5 seconds)
        var interval = 5000;

        // Function to trigger the carousel's next action
        function nextSlide() {
