      ...
      <div class="modal-body">
        ...
        <div id="hidandshowlogin">
          <div class="form-floating">
            <input type="text" required="required" class="form-control" placeholder="Enter Your Phone Number Here ..." id="val"><label for="floatingInput">Enter Your Phone Number Here ...</label>
          </div><br>
          <div class="form-floating">
            <input type="text" required="required" class="form-control" placeholder="Enter Your Password Here ..." id="val1" ><label for="floatingInput">Enter Your Password Here ...</label>
          </div><br>
        ...
        <div id="hidandshowsignup" style="display: none;">
          ...
          <div class="form-floating">
            <input type="text" required="required" class="form-control" placeholder="Enter Your Last Name Here ..." id="ln"><label for="floatingInput">Enter Your Last Name Here ...</label>
          </div><br>
          <div class="form-floating">
            <input type="text" required="required" class="form-control" placeholder="Enter Your Phone Number Here ..." id="phone"><label for="floatingInput">Enter Your Phone Number Here ...</label>
          </div><br>
                    <div class="form-floating">
            <input type="text" required="required" class="form-control" placeholder="Enter Your E-mail Here ..." id="em"><label for="floatingInput">Enter Your E-mail Here ...</label>
          </div><br>
          <div class="form-floating">
          <div class="form-floating">
            <input type="text" required="required" class="form-control" placeholder="Enter Your Password Here ..." id="pass" ><label for="floatingInput">Enter Your Password Here ...</label>
          </div><br>
          <input type="text" required="required" class="form-control" placeholder="Re-Write Your Password Here ..." id="pass1" ><label for="floatingInput">Re-Write Your Password Here ...</label>
          </div><br>
...
function chechinput() {
  ...
  if (fni!=''&&lni!=''phonei!=''emi!=''passi!=''pass1i!='') {
     document.getElementById('signupb').removeAttribute('disabled');
  }
  // body...
}
</script>
