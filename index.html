    ...
    <body>
      ...
      <div class="col-md-8" style="padding-top: 10px;"><h4>Schools and internships Solution
        <a class="btn btn-square btn-light m-1" href=""><img src="image/phone-icon.png" width="30px;" height="30px"  style="border-radius: 2px; padding-left: 8px;"></a>
                                            <a class="btn btn-square btn-light m-1" href=""><img src="image/twitter123.png" width="30px" height="30px"></a>
 ...
 <div class="container-fluid" style="top: 210px;position: absolute;">
                    <div class="row">
                        <div class="col-md-10" style="border-right: 1px solid rgba(0, 0, 0, 0.5); background-image: url('image/showschool.jpg');background-size: cover;background-repeat: no-repeat;background-attachment: fixed;padding: 0;"><div style="background-color:rgba(0, 0, 0, 0.4);width: 100%; height: 100%;position: relative;"><br><br>
                             ...
                             <div class="caption" style="z-index: 9;position: relative;background-color: rgba(0, 0, 0, 0.5);width: 90%;border-radius: 10px;left: 30px;padding: 10px;">
    ...
    <div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <h2 style="color:#fff;">  Find Schools And Internshps</h2>
              <p>With us It is easy to find best <a href="#" style="display:inline;color: orange;">schools </a> and <a  href="#" style="display:inline;color: orange;">Internships </a> of your choice. the way you find them is very easy by few click on your smart phone or computer.</p>
            </div>
            <div class="carousel-item">
                <h2 style="color:#fff;">  No more stress of schools and internship</h2>
              <p>many people have been struggling of finding fit <a href="#" style="display:inline;color: orange;">schools </a> for their self/ their children or fail to get best  <a  href="#" style="display:inline;color: orange;">Internships </a> of their choice. but with our online schools and internships finding it became easy</p>
            </div>
            <!-- Add more slides as needed -->
                                ...
                                <div class="col-md-2">
                                    <img src="image/ads.png"><img src="image/nurse.jpg" style="width: 100%;">
                                              ...
                                              <footer class="site-footer" style="background-color: black; background-image: url('image/footer.PNG');background-size: cover;background-repeat: no-repeat;background-attachment: fixed;color: white;">
                                                  <div class="container" >
                                                    <div class="row"> 
                                                        <div class="col-md-12">
                                                              <div class="copyright-text-wrap">
                                                                    <div style="float: left;display: inline-block;">
                                                                <a href="Faq.php" class="btn btn-dark">FAQ</a>
                                                                <a href="contactus.php" class="btn btn-dark">Contact Us</a>
                                                            </div>


                                                                <span class="copyright-text">Copyright © 2023 By  <a href="#" style="color:orange;">Study Now</a> Company. All rights reserved</span>
                                                              </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-8">
                                                              ...
                                                              <p style="font-size: 20px;color: white;"><img src="image/location12.png" width="25px" height="25px"><strong> Address:</strong> Gikondo/KIGALI, <br>
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="image/small/Rwanda.png" width="25px" height="25px">RWANDA
                                                </p>

    
                                                <p style="font-size: 20px;color: white;"><img src="image/phone.ico" width="25px" height="25px"><strong> Cell No:</strong> +250 782154032 </p>
                                                          ...
                                                          <div class="col-md-4">
                                                               <p style="font-size: 15px;color: white;"><img src="image/whatsapp.png" width="25px" height="25px"><strong> whatsapp:</strong> +250 782154032 </p>
                                                <p style="font-size: 20px; color: white;">
                                                    ...
                                                    <strong> Email:</strong> samsadiva@gmail.com
                                                      ...
                                                      <div class="row">
                                                          <div class="col-md-12">
                                                              <a class="facebook-icon" href="#"><img src="image/facebook.png" width="30px" height="30px"></a>
                                        <a class="twitter-icon" href="#"><img src="image/twitter123.png" width="30px" height="30px"></a>
...
<!-- THIS IS THE PART OF ALL MODAL ----------------------.......................------------------ -->
   <!-- The Modal 1  WHEN MY ACCOUNT IS CLICKED ..... -->
