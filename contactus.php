...
.dropdown-menu a{padding-left: 30px;}
 ...
 <div class="container-fluid" style="top: 210px;position: absolute;">
           ...
           <!-- Contact Start -->
                <div class="btn btn-sm border rounded-pill text-primary px-3 mb-3" style="color:white!important;">Contact Us</div>
                <h1 style="color:white;">If You Have Any Query, Please Contact Us</h1>
         ...
         <div class="col-md-5"> 
                                                ...
                                                <p style="font-size: 20px;"><img src="image/location12.png" width="60px" height="60px"><strong> Address:</strong> Gikondo/KIGALI, <br>
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="image/small/Rwanda.png" width="25px" height="25px">RWANDA
                                                </p><br>

    
                                                <p style="font-size: 20px;"><img src="image/phone.ico" width="40px" height="40px"><strong> Cell No:</strong> +250 782154032 </p>
                                                <p style="font-size: 20px;"><img src="image/whatsapp.png" width="40px" height="40px"><strong> whatsapp:</strong> +250 782154032 </p>
                                                <p style="font-size: 20px;">
                                                    <img src="image/email.png" width="40px" height="40px">
                                                    <strong> Email:</strong> samsadiva@gmail.com
                                                </p>

                               <a class="facebook-icon" href="#"><img src="image/facebook.png" width="40px" height="40px" style="background-color:white;"></a>
                                        <a class="twitter-icon" href="#"><img src="image/twitter.png" width="40px" height="40px" style="background-color:white;"></a>
                                        <a class="linkedin-icon" href="#"><img src="image/linkedin.png" width="40px" height="40px"></a>
                                        <a class="tiktok-icon" href="#"><img src="image/tiktok.png" width="40px" height="40px"></a>
                                        <a class="youtube-icon" href="#"><img src="image/youtube.png" width="40px" height="40px"></a>
